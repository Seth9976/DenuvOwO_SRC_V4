...
CounterUpdater(PVOID Context);

IMPORT_EXPORT_VMM HANDLE TargetProcessId;
IMPORT_EXPORT_VMM BOOLEAN NotifyRoutineActive;
IMPORT_EXPORT_VMM BOOLEAN StopCounterThread;
IMPORT_EXPORT_VMM HANDLE CounterThreadHandle;

IMPORT_EXPORT_VMM HANDLE TrackedProcessId;
IMPORT_EXPORT_VMM BOOLEAN ProcessExitCleanup;
IMPORT_EXPORT_VMM UINT64 TargetCR3;
IMPORT_EXPORT_VMM UINT64 OrigLstar;
IMPORT_EXPORT_VMM UINT64 TargetSysHandler;
IMPORT_EXPORT_VMM UINT64 SyscallBypassMagic;
IMPORT_EXPORT_VMM UINT64 LstarHook;
